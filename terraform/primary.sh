...
mkdir -p /u01/app/ogg /u02/oradata /u03/redo /u01/app/oraInventory
...
su - oracle <<EOF
cd /u01/app/ogg
# unzip /tmp/fbo_ggs_Linux_x64_Oracle19c.zip
./ggsci <<GGEOF
CREATE SUBDIRS
EXIT
GGEOF
...
echo "Primary VM setup complete (Oracle DB software + GoldenGate)"
